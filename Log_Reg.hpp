...
public:
    ...
    LogisticRegression(double learning_rate);
    ...
    std::tuple<std::vector<std::vector<double>>, double> update(std::vector<std::vector<double>>& dW, double& db, std::vector<std::vector<double>>& W, double& b);
